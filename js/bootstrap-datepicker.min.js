...
(function (e, t) {
    ...
    e.extend(e.ui, {
        plugin: {
            ...
            var r = n && n === "left" ? "scrollLeft" : "scrollTop", i = false;
            if (t[r] > 0) {
                return true
            }
            t[r] = 1;
    ...
    $.extend(Datepicker.prototype, {
        ...
        _attachments: function (e, t) {
            ...
            if (i == "button" || i == "both") {
                ...
                t.trigger.click(function () {
                    if ($.datepicker._datepickerShowing && $.datepicker._lastInput == e[0]) $.datepicker._hideDatepicker(); else if ($.datepicker._datepickerShowing && $.datepicker._lastInput != e[0]) {
        ...
        _doKeyDown: function (e) {
            ...
            if ($.datepicker._datepickerShowing) switch (e.keyCode) {
                ...
                default:
                    n = false
            } else if (e.keyCode == 36 && e.ctrlKey) $.datepicker._showDatepicker(this); else {
                n = false
            }
            if (n) {
                e.preventDefault();
        ...
        _showDatepicker: function (e) {
            ...
            if (!t.inline) {
                ...
                if ($.effects && ($.effects.effect[o] || $.effects[o])) t.dpDiv.show(o, $.datepicker._get(t, "showOptions"), u, a); else t.dpDiv[o || "show"](o ? u : null, a);
                if (!o || !u) a();
        ...
        _updateDatepicker: function (e) {
            ...
            if (!!n.length) {
                n.css({left: -t[0], top: -t[1], width: e.dpDiv.outerWidth(), height: e.dpDiv.outerHeight()})
            }
        ...
        _hideDatepicker: function (e) {
            ...
            if (this._datepickerShowing) {
                ...
                if ($.effects && ($.effects.effect[n] || $.effects[n])) t.dpDiv.hide(n, $.datepicker._get(t, "showOptions"), r, i); else t.dpDiv[n == "slideDown" ? "slideUp" : n == "fadeIn" ? "fadeOut" : "hide"](n ? r : null, i);
                if (!n) i();
                this._datepickerShowing = false;
        ...
        _selectDate: function (e, t) {
            ...
            if (i) i.apply(r.input ? r.input[0] : null, [t, r]); else if (r.input) r.input.trigger("change");
            if (r.inline) this._updateDatepicker(r); else {
                this._hideDatepicker();
        ...
        parseDate: function (e, t, n) {
            ...
            var v = function (e, n, r) {
                ...
                if (s != -1) return s + 1; else throw"Unknown name at position " + g
            };
            var m = function () {
            ...
            for (var y = 0; y < e.length; y++) {
                if (h) if (e.charAt(y) == "'" && !p("'")) h = false; else m(); else switch (e.charAt(y)) {
                    case"d":
                        l = d("d");
                        break;
                    case"D":
            ...
            if (a == -1) a = (new this.CDate).getFullYear(); else if (a < 100) a += (new this.CDate).getFullYear() - (new this.CDate).getFullYear() % 100 + (a <= r ? 0 : -100);
            if (c > -1) {
                f = 1;
                l = c;
                do {
        ...
        formatDate: function (e, t, n) {
            ...
            if (t) for (var h = 0; h < e.length; h++) {
                if (c) if (e.charAt(h) == "'" && !u("'")) c = false; else l += e.charAt(h); else switch (e.charAt(h)) {
                    case"d":
                        l += a("d", t.getDate(), 2);
                        break;
                    case"D":
        ...
        _possibleChars: function (e) {
            ...
            for (var i = 0; i < e.length; i++) if (n) if (e.charAt(i) == "'" && !r("'")) n = false; else t += e.charAt(i); else switch (e.charAt(i)) {
                case"d":
                case"m":
                case"y":
                case"@":
        ...
        _generateHTML: function (e) {
            ...
            var g = this._canAdjustMonth(e, -1, d, p) ? '<a class="ui-datepicker-prev btn btn-link" data-handler="prev" data-event="click"' + ' title="' + m + '">' + (n ? '<i class="fa fa-chevron-right"></i>' : '<i class="fa fa-chevron-left"></i>') + "</a>" : i ? "" : '<a class="ui-datepicker-prev btn btn-link ui-state-disabled" title="' + m + '">' + (n ? '<i class="icon-circle-arrow-right"></i>' : '<i class="fa fa-chevron-left"></i>') + "</a>";
            ...
            var b = this._canAdjustMonth(e, +1, d, p) ? '<a class="ui-datepicker-next btn btn-link" data-handler="next" data-event="click"' + ' title="' + y + '">' + (n ? '<i class="fa fa-chevron-left"></i>' : '<i class="icon-circle-arrow-right"></i>') + "</a>" : i ? "" : '<a class="ui-datepicker-next btn btn-link ui-state-disabled" title="' + y + '">' + (n ? '<i class="fa fa-chevron-left"></i>' : '<i class="icon-circle-arrow-right"></i>') + "</a>";
...
$(document).ready(function () {
    $("#date-picker , #date-picker-out ,#date-picker-1 ,#date-picker-2 ,#date-picker-3 ,#date-picker-4 ,#date-picker-5 ,#date-picker-6 ,#date-picker-7").datepicker({
        changeMonth: true,
        changeYear: true
    });
});